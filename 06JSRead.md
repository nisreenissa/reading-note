...
# The closing curly brace is not followed by a semicolon, but the statements should end with semicolon.you can write comments to give more details about the code to make it easier to read or understand . 
# you can do this by /* put multi line comment here */
# or for single line comment //

# var today= new Date(); // this is to create a datevar hour Now = today.getHours(); // this will give me the current hour var greeting; 
The greeting var will use if statement to give the correct time 
# if (hourNow > 18) 
